          ...
          <div class="x_content">
            ...
            <form action="../netting/operation.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="bank_iban" name="bank_iban" value="<?php echo $getbank['bank_iban'] ?>" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="bank_accountname" name="bank_accountname" value="<?php echo $getbank['bank_accountname'] ?>" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
