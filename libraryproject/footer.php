		...
		<div class="container">
			<div class="row">
				<div class="col-md-4"><!--footer twitter widget-->
					...
					<a href="http://<?php echo $getsetting['settings_twitter'] ?>" class="btn btn-default btn-follow"><i class="fa fa-twitter fa-2x"></i><div>Follow us on twitter</div></a>
					<a href="http://<?php echo $getsetting['settings_facebook'] ?>" class="btn btn-default btn-follow"><i class="fa fa-facebook fa-2x"></i><div>Follow us on facebook</div></a>
					<a href="http://<?php echo $getsetting['settings_linkedin'] ?>" class="btn btn-default btn-follow"><i class="fa fa-linkedin fa-2x"></i><div>Follow us on linkedin</div></a>
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						...
						<li class="fmail lastone"><?php echo $getsetting['settings_email']; ?></li>
					</ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;All rights reserved by <a href="#"><?php echo $getsetting['settings_author']; ?></a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						<a href="http://<?php echo $getsetting['settings_twitter'] ?>" class="ftwitter">twitter</a>
						<a href="http://<?php echo $getsetting['settings_facebook'] ?>" class="ffacebook">facebook</a>
						<a href="http://<?php echo $getsetting['settings_linkedin'] ?>" class="flinkedin">linkedin</a>
